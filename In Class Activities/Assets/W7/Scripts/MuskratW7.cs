...
public class MuskratW7 : MonoBehaviour
{
    ...
    private void MoveOrbitMode()
    {
        ...
        Vector3 rotation = transform.TransformDirection(Vector3.up);
        ...
        //      bubble.
        _animator.SetBool("running", Mathf.Abs(transform.TransformDirection(_rigidbody.linearVelocity).x) > 0);
        _animator.SetBool("flying", Mathf.Abs(transform.TransformDirection(_rigidbody.linearVelocity).y) > 0);
    ...
    private void MoveNormal()
    {
        ...
        transform.position += movement * transform.TransformDirection(Vector3.forward) * _moveSpeed * Time.deltaTime;
        ...
        _animator.SetBool("running", Mathf.Abs(_rigidbody.linearVelocity.x) > 0);
        _animator.SetBool("flying", Mathf.Abs(_rigidbody.linearVelocity.y) > 0.05);
